        ...
        <div :style="{ marginBottom: '24px' }">
          ...
          <div :style="{ marginTop: '24px' }">
            <a-list :split="false">
              ...
              <a-list-item>
                <a-switch slot="actions" size="small" :disabled="(layout === 'topmenu')" :checked="dataFixSiderbar" @change="handleFixSiderbar" />
                <a-list-item-meta>
        ...
        <div :style="{ marginBottom: '24px' }">
          ...
          <div>
            <a-list :split="false">
              ...
              <a-list-item>
                <a-switch slot="actions" size="small" :defaultChecked="multiTab" @change="onMultipageWeak" />
                <a-list-item-meta>
...
export default {
  ...
  mounted () {
    ...
    if (this.multiTab !== config.multiTab) {
      this.$store.commit(TOGGLE_MULTI_TAB, this.multiTab)
    }
  },
  methods: {
    showDrawer () {
