export default {
  ...
  'user.register-result.msg': 'Account：registered at {mail}',
  'user.register-result.activation-email':
    'The activation mail has been sent to your mail address and is valid for 24 hours. Please log in to the mail in time and click on the link in the mail to activate the account.',
  'user.register-result.back-home': 'Back to home',
  'user.register-result.view-mailbox': 'View mailbox',
  'user.email.required': 'Please enter your mail!',
  'user.email.wrong-format': 'The mail address is in the wrong format!',
  'user.userName.required': 'Please enter account name or mail address',
