<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="plus" @click="$refs.merchantEdit.edit('','add')">新建</a-button>
    </div>
    <a-table
      bordered
      :columns="columns"
...
<script>
import { page, del } from '@/api/payment/merchant'
...
export default {
  ...
  methods: {
    ...
    edit (record) {
      this.$refs.merchantEdit.edit(record.id, 'edit')
    },
    delete (record) {
    ...
    show (record) {
      this.$refs.merchantEdit.edit(record.id, 'show')
    },
    handleOk () {
      this.init()
    }
