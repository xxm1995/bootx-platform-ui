<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="plus" @click="$refs.aliPayConfigEdit.edit('','add')">新建</a-button>
    </div>
    <a-table
      bordered
      :columns="columns"
...
<script>
import { page, del } from '@/api/payment/payconfig/aliPayConfig'
...
export default {
  ...
  methods: {
    ...
    edit (record) {
      this.$refs.aliPayConfigEdit.edit(record.id, 'edit')
    },
    delete (record) {
    ...
    show (record) {
      this.$refs.aliPayConfigEdit.edit(record.id, 'show')
    },
    handleOk () {
      this.init()
    }
